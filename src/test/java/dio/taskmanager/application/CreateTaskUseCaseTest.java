...
//    }
    ...
    void should_create_task_sucessfully(){
        //given
        var input = new CreateTaskInput("Estudar java", Optional.of("Finalizaar o módulo de Records"));
        ...
        assertEquals(Optional.of("Finalizaar o módulo de Records"), output.description());
